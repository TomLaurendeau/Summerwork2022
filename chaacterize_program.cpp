...
int main(int argc, char **argv) {
	...
	printf("Full Path Application selected: %s\n",filepath);
	printf("Counters selected: %d, %d, %d, %d\n", counter1, counter2, counter3, counter4);
	printf("Argument selected : %s\n", argument);
	printf("Core selected: %d\n\n", core);
	...
	std::string file_exe;
	file_exe.append(filepath);
	file_exe.append(" ");
	file_exe.append(argument);
	file_exe.append(" ");
	file_exe.append(std::to_string(core)); // core here
	file_exe.append(" ");
	file_exe.append("1");
	printf("%s", file_exe.c_str());
